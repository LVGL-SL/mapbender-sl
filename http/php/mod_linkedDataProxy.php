...
switch ($f) {
	...
	#map {
		...
		$html .= '            <a class="navbar-brand" href="https://github.com/LVGL-SL/geoportal-sl" target="_blank">GeoPortal.sl</a>' . $newline;
		$html .= '        </span>' . $newline;
		$html .= '        <span>' . $newline;
