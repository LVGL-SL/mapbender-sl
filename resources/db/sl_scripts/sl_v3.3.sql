SET search_path TO mapbender,public;

-- Ticket #9607
-- ALTER TABLE mapbender.mb_metadata ALTER responsible_party_name TYPE varchar(250);
-- materialized views mv_search_dataset and search_application_view as well as view dataset_search_table need to be dropped and recreated because they depend on the altered column
BEGIN;
DROP MATERIALIZED VIEW mapbender.search_application_view;
DROP VIEW mapbender.dataset_search_table;
DROP MATERIALIZED VIEW mapbender.mv_search_dataset;
DROP VIEW mapbender.search_dataset_view;

ALTER TABLE mapbender.mb_metadata ALTER responsible_party_name TYPE varchar(250);

CREATE VIEW mapbender.search_dataset_view AS
...
CREATE MATERIALIZED VIEW mapbender.mv_search_dataset AS
 SELECT DISTINCT ON (datasets.metadata_id) datasets.user_id,
    datasets.dataset_id,
    datasets.metadata_id,
    datasets.dataset_srs,
...
ALTER MATERIALIZED VIEW mapbender.mv_search_dataset OWNER TO u_mapbender;
...
CREATE UNIQUE INDEX mv_search_dataset_unique ON mapbender.mv_search_dataset USING btree (user_id, dataset_id, metadata_id);
CREATE INDEX IF NOT EXISTS gist_wst_dataset_the_geom ON mapbender.mv_search_dataset USING gist (the_geom);
CREATE INDEX IF NOT EXISTS idx_wst_dataset_searchtext ON mapbender.mv_search_dataset USING btree (searchtext);
CREATE INDEX IF NOT EXISTS idx_wst_dataset_department ON mapbender.mv_search_dataset USING btree (department);
CREATE INDEX IF NOT EXISTS idx_wst_dataset_md_topic_cats ON mapbender.mv_search_dataset USING btree (md_topic_cats);
CREATE INDEX IF NOT EXISTS idx_wst_dataset_metadata_id ON mapbender.mv_search_dataset USING btree (metadata_id);
CREATE INDEX IF NOT EXISTS idx_wst_dataset_dataset_id ON mapbender.mv_search_dataset USING btree (dataset_id);
CREATE INDEX IF NOT EXISTS idx_wst_dataset_md_inspire_cats ON mapbender.mv_search_dataset USING btree (md_inspire_cats);
CREATE INDEX IF NOT EXISTS idx_wst_dataset_md_custom_cats ON mapbender.mv_search_dataset USING btree (md_custom_cats);
CREATE INDEX IF NOT EXISTS idx_wst_dataset_timebegin ON mapbender.mv_search_dataset USING btree (timebegin);
CREATE INDEX IF NOT EXISTS idx_wst_dataset_timeend ON mapbender.mv_search_dataset USING btree (timeend);
CREATE INDEX IF NOT EXISTS idx_wst_dataset_timestamp ON mapbender.mv_search_dataset USING btree (dataset_timestamp);

CREATE VIEW mapbender.dataset_search_table AS
 SELECT mv_search_dataset.user_id,
   ...
   FROM mv_search_dataset;

ALTER VIEW mapbender.dataset_search_table OWNER TO u_mapbender;
...
CREATE MATERIALIZED VIEW mapbender.search_application_view AS
 SELECT DISTINCT ON (datasets.metadata_id) datasets.user_id,
    datasets.dataset_id,
    datasets.metadata_id,
    datasets.dataset_srs,
...
ALTER MATERIALIZED VIEW mapbender.search_application_view OWNER TO u_mapbender;
GRANT ALL ON TABLE mapbender.search_application_view TO r_admin;
GRANT ALL ON TABLE mapbender.search_application_view TO r_security WITH GRANT OPTION;
GRANT SELECT ON TABLE mapbender.search_application_view TO r_default;

CREATE INDEX IF NOT EXISTS gist_wst_application_the_geom ON mapbender.search_application_view USING gist (the_geom);
CREATE INDEX IF NOT EXISTS idx_wst_application_searchtext ON mapbender.search_application_view USING btree (searchtext);
CREATE INDEX IF NOT EXISTS idx_wst_application_department ON mapbender.search_application_view USING btree (department);
CREATE INDEX IF NOT EXISTS idx_wst_application_md_topic_cats ON mapbender.search_application_view USING btree (md_topic_cats);
CREATE INDEX IF NOT EXISTS idx_wst_application_metadata_id ON mapbender.search_application_view USING btree (metadata_id);
CREATE INDEX IF NOT EXISTS idx_wst_application_dataset_id ON mapbender.search_application_view USING btree (dataset_id);
CREATE INDEX IF NOT EXISTS idx_wst_application_md_inspire_cats ON mapbender.search_application_view USING btree (md_inspire_cats);
CREATE INDEX IF NOT EXISTS idx_wst_application_md_custom_cats ON mapbender.search_application_view USING btree (md_custom_cats);
CREATE INDEX IF NOT EXISTS idx_wst_application_timebegin ON mapbender.search_application_view USING btree (timebegin);
